...
import { OverlayScrollbarsComponentRef } from './react-scrollable.type';
import { provideWindowScroll } from './react-scrollable.extension';

// const OverlayScrollbarsComponent = OverlayScrollbarsComponent;
...
vi.useFakeTimers({
  toFake: ['requestAnimationFrame', 'cancelAnimationFrame', 'requestIdleCallback', 'cancelIdleCallback'],
});
...
describe('OverlayScrollbarsComponent', () => {
  ...
  describe('correct rendering', () => {
    test('correct root element with instance', () => {
      const elementA = 'code';
      const elementB = 'span';
      const elementC = (props: any) => <section {...props} ref={props.ref} />;
    ...
    test('className', () => {
      const { container, rerender } = render(<OverlayScrollbarsComponent className="overlay scrollbars" />);
    ...
    test('style', () => {
      const { container, rerender } = render(<OverlayScrollbarsComponent style={{ width: '22px' }} />);
  ...
  test('ref', () => {
    const ref: RefObject<OverlayScrollbarsComponentRef | null> = { current: null };
  ...
  test('options', () => {
    const ref: RefObject<OverlayScrollbarsComponentRef | null> = { current: null };
    const { rerender } = render(<OverlayScrollbarsComponent options={{ paddingAbsolute: true, overflow: { y: 'hidden' } }} ref={ref} />);
    ...
    rerender(
      <OverlayScrollbarsComponent element="span" options={undefined} ref={ref as any as RefObject<OverlayScrollbarsComponentRef<'span'>>} />
    );
  ...
  test('events', () => {
    ...
    const ref: RefObject<OverlayScrollbarsComponentRef | null> = { current: null };
    const { rerender } = render(<OverlayScrollbarsComponent events={{ initialized: onInitialized }} ref={ref} />);
    const instance = ref.current!.osInstance()!;
    ...
    rerender(<OverlayScrollbarsComponent events={{ updated: [onUpdated, onUpdated2] }} ref={ref} />);
    ...
    rerender(
      <OverlayScrollbarsComponent element="span" events={undefined} ref={ref as any as RefObject<OverlayScrollbarsComponentRef<'span'>>} />
    );
